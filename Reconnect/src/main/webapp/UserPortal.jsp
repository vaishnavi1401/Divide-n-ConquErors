    ...
    <body>
        ...
        <div class="main_container">
            ...
            <div class="icon-bar">
                ...
                <a onclick="openSearch(id)" id="non_friends"><i class="fa fa-search"></i></a>
                <a href="F:\Codefury\HTML docs\User\AddContact.html" id="addContact"><i class="fa fa-plus" aria-hidden="true"></i></a>
                <a onclick="openSearch(id)" id="contacts" ><i class="fa fa-address-book" aria-hidden="true"></i></a>
                <a onclick="openSearch(id)" id="friends"><i class="fa fa-users"></i></a>
